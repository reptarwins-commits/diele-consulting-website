...
*If you are seeing these patterns in your organization and want to understand where the connection gaps are, I've built a diagnostic for exactly this. [The Clear Direction Diagnostic](#). It takes 10 minutes and tells you where to look first.*
