    ...
    <main className="bg-[#111111] min-h-screen">
      ...
      <section className="pt-32 pb-12 border-b border-white/5">
        <div className="max-w-3xl mx-auto px-6">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-[#909090] hover:text-[#E8E8E8] text-sm mb-10 transition-colors duration-200"
          >
            ← Back to Writing
          </Link>
          ...
          {post.excerpt && (
            <p className="text-[#C8C8C8] text-lg leading-relaxed border-l-2 border-[#B22222] pl-5">{post.excerpt}</p>
          )}
        </div>
      </section>
      ...
      <article className="py-16">
        <div className="max-w-3xl mx-auto px-6 prose-joe" dangerouslySetInnerHTML={{ __html: html }} />
      </article>
