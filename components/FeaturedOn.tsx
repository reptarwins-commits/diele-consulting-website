      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className={`transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          <div className="flex items-center gap-3 mb-10">
            ...
            <span className="text-[#EC4545] text-xs tracking-[0.3em] uppercase font-semibold">Featured On</span>
            <div className="w-6 h-[1px] bg-[#B22222]" />
          </div>
            ...
            {mediaItems.map((item, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="inline-flex items-center gap-1 text-[#EC4545] text-xs font-semibold tracking-wide uppercase">
                    {item.label}
