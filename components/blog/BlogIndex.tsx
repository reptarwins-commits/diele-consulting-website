...
// Posts are passed in from the server component (sourced from Notion).
const externalPieces = [
  {
    publication: "IndustryWeek",
    title: "To Fix Quality, You Must First Fix Culture",
    excerpt:
      "Quality isn't a department — it's what happens when your culture is healthy. Sustainable improvement is impossible without addressing what's underneath.",
  ...
  },
  {
    ...
    excerpt:
      "The shift from command-and-control oversight to coaching-oriented leadership. What it really takes to evolve from manager to leader.",
    ...
    <div className="bg-[#111111] min-h-screen">
      ...
      <section className="pt-32 pb-16 bg-[#111111] border-b border-white/5">
        ...
        <div className={`max-w-4xl mx-auto px-6 transition-all duration-700 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-[#E8E8E8] mb-4">Essays on leadership.</h1>
        ...
        <section className="py-12 border-b border-white/5">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <Link
              ...
              className="group block border border-[#B22222]/20 bg-[#1a1a1a] hover:border-[#B22222]/60 hover:bg-[#150a0a] transition-all duration-200 p-10 hover:-translate-y-1"
            >
              <Meta post={featured} />
          ...
          <div className="space-y-4">
            {externalPieces.map((piece, i) => (
              ...
              >
                <div className="flex-shrink-0 w-28 pt-0.5">
                  {piece.publication === "IndustryWeek" ? (
                    ...
                    <div className="text-[#909090] group-hover:text-[#C8C8C8] transition-colors duration-200 flex items-center gap-1">
                      ...
                      <span className="font-sans font-light text-[9px] tracking-[0.15em] uppercase leading-none opacity-80">
                        Quality
                        <br />
                        Progress
                      </span>
                ...
                <div>
                  <h3 className="text-[#E8E8E8] font-semibold text-base mb-1 group-hover:text-white transition-colors duration-200">&ldquo;{piece.title}&rdquo;</h3>
