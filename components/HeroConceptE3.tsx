...
export default function HeroConceptE() {
  ...
  useEffect(() => {
    ...
    at(T_LINE1_IN,  () => { setLine1Visible(true); seqStage.current = 1; });
  ...
  return (
    <section className="hero-section relative min-h-screen flex flex-col justify-center bg-[#111111] overflow-hidden">
      ...
      {/* Line grid — top-left visible, diagonal fade */}
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 pt-16 pb-20">
